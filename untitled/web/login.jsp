...
<body style="background-color: #56baed">
	<div class="contain">
		...
		<div style="font-size: 1.5em;text-align: center;letter-spacing: 10px">用户登录</div>
		<form action="login" method="post">
			<input type="text" name="dl.id" placeholder="工号" class="kk">
			<input type="password" name="dl.password" placeholder="密码" class="kk">
