...
<table border="1" cellpadding="10" width="1000">
    <tr align="center" bgcolor="silver">
        <th>课程号</th><th>课程名</th><th>开课学期</th><th>学时</th><th>学分</th><th>专业</th><th>周次</th><th>上次时间</th><th>地点</th><th>操作</th><th>操作</th>
    </tr>
    <s:iterator value="#request.list" id="kc">
        <tr>
            ...
            <td><s:property value="#kc.weekBegin"/>~<s:property value="#kc.weekEnd"/></td>
            <td>星期<s:property value="#kc.weekDay"/>&nbsp;第<s:property value="#kc.lesson"/>节</td>
            <td><s:property value="#kc.destination"/></td>
            <td>
                <a href="deleteXs.action?kc.xh=<s:property value="#kc.kch"/>" onClick="if(!confirm('确定删除该生信息吗？'))return false;else return true;">删除</a>
            </td>
            <td>
                <a href="updateXsView.action?kc.xh=<s:property value="#kc.kch"/>">修改</a>
            </td>
        </tr>
    </s:iterator>
    <tr>
